  ...
  postSavedMovie(movie) {
    const queryParams = {
      ...
      body: JSON.stringify({
        ...
        image: calcPath(movie.image.formats.small? movie.image.formats.small.url: movie.image.url),
        trailerLink: movie.trailerLink,
        thumbnail: calcPath(movie.image.formats.thumbnail? movie.image.formats.thumbnail.url: movie.image.url),
        movieId: movie.id,
        nameRU: movie.nameRU,
        nameEN: movie.nameEN,
      }),
